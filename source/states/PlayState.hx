...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['YOU PIECE SOME SHIT >:(', 0.2], //From 0% to 19%
		['wha', 0.4], //From 20% to 39%
		['YOU LOSER', 0.5], //From 40% to 49%
		['Uh', 0.6], //From 50% to 59%
		['Uh Wow', 0.69], //From 60% to 68%
		['Nice buddy', 0.7], //69%
		['Great', 0.8], //From 70% to 79%
		['Wow!', 0.9], //From 80% to 89%
		['SUPER!', 1], //From 90% to 99%
		['SUPER COMBO!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
